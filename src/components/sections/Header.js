                 ...
                 <div>
                    ...
                    <div id="mainMenu">
                        <div className="container">
                            <nav>
                                <ul>
                                    <li activeOnlyWhenExact={true} activeclassName="selected"><NavItem to="/" >خانه</NavItem></li>
                                    <li className="dropdown"><NavItem to="/about">آموزش</NavItem>
                                        <ul className="dropdown-menu">
                                            <li className="dropdown-submenu"><a href="#">Topbar</a>
                                                <ul className="dropdown-menu">
                                            ...
                                            <li className="dropdown-submenu"><a href="#">Header</a>
                                                <ul className="dropdown-menu">
                                                    ...
                                                    <li className="dropdown-submenu"><a href="#">Logo</a>
                                                        <ul className="dropdown-menu">
                                                    ...
                                                    <li className="dropdown-submenu"><a href="#">Menu Positions</a>
                                                        <ul className="dropdown-menu">
                                            ...
                                            <li className="dropdown-submenu"><a href="#">Main Menu<span className="badge badge-danger">NEW</span></a>
                                                <ul className="dropdown-menu">
                                                    ...
                                                    <li className="dropdown-submenu"><a href="#">Outline</a>
                                                        <ul className="dropdown-menu">
                                                    ...
                                                    <li className="dropdown-submenu"><a href="#">Rounded</a>
                                                        <ul className="dropdown-menu">
                                                    ...
                                                    <li className="dropdown-submenu"><a href="#">Positions</a>
                                                        <ul className="dropdown-menu">
                                            ...
                                            <li className="dropdown-submenu"><a href="#">Page Title</a>
                                                <ul className="dropdown-menu">
                                            ...
                                            <li className="dropdown-submenu"><a href="#">Page Menu<span className="badge badge-danger">NEW</span></a>
                                                <ul className="dropdown-menu">
                                            ...
                                            <li className="dropdown-submenu"><a href="#">Sidebars</a>
                                                <ul className="dropdown-menu">
                                            ...
                                            <li className="dropdown-submenu"><a href="#">Footers</a>
                                                <ul className="dropdown-menu">
                                            ...
                                            <li className="dropdown-submenu"><a href="#">Options</a>
                                                <ul className="dropdown-menu">
                                            ...
                                            <li><a href="preview/index.html">Layout Demos<span className="badge badge-primary">220+</span></a></li>
                                        </ul>
                                    </li>
                                    <li className="dropdown"><NavItem to="/about">اخبار</NavItem>
                                        <ul className="dropdown-menu">
                                            <li className="dropdown-submenu"><a href="#">Sliders</a>
                                                <ul className="dropdown-menu">
                                            ...
                                            <li><a href="page-loaders.html">Page Loaders<span className="badge badge-danger">NEW</span></a></li>
                                            <li className="dropdown-submenu"><a href="#">Modal Auto Open<span className="badge badge-danger">NEW</span></a>
                                                <ul className="dropdown-menu">
                                            ...
                                            <li className="dropdown-submenu"><a href="#">Cookie Notify<span className="badge badge-danger">NEW</span></a>
                                                <ul className="dropdown-menu">
                                                    <li><a href="cookie-notify.html">Top position</a></li>
                                                    <li><a href="cookie-notify-bottom.html">Bottom position</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="shape-dividers.html">Shape Dividers<span className="badge badge-danger">NEW</span></a></li>
                                            <li className="dropdown-submenu"><a href="#">Menu Labels</a>
                                                <ul className="dropdown-menu">
                                                    <li><a href="#">Label (new)<span className="badge badge-danger">NEW</span></a></li>
                                                    <li><a href="#">Label (hot)<span className="badge badge-danger">HOT</span></a></li>
                                                    <li><a href="#">Label (popular)<span className="badge badge-success">POPULAR</span></a></li>
                                                    <li><a href="#">Label (sale)<span className="badge badge-warning">SALE</span></a></li>
                                                    <li><a href="#">Label (info)<span className="badge badge-info">INFO</span></a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </li>
                                    <li className="dropdown mega-menu-item"><NavItem to="/about"> تحلیل بورس </NavItem>
                                        <ul className="dropdown-menu">
                                                ...
                                                <div className="row">
                                                    <div className="col-lg-2">
                                                        <ul>
                                                            ...
                                                            <li><a href="component-bootstrap-switch.html">BS Switch<span className="badge badge-danger">NEW</span></a></li>
                                                            <li><a href="component-bootstrap-notify.html">BS Notify<span className="badge badge-danger">NEW</span></a></li>
                                                    ...
                                                    <div className="col-lg-2">
                                                        <ul>
                                                            <li><a href="component-charts-chartjs.html">Charts<span className="badge badge-danger">NEW</span></a></li>
                                                            <li><a href="component-calendar.html">Calendar<span className="badge badge-danger">NEW</span></a></li>
                                                            ...
                                                            <li><a href="shortcode-countdown.html">Countdown<span className="badge badge-danger">NEW</span></a></li>
                                                            <li><a href="shortcode-counters.html">Counter Numbers</a></li>
                                                            <li><a href="component-clipboard.html">Clipboard<span className="badge badge-danger">NEW</span></a></li>
                                                            <li><a href="component-datatable.html">Data Tables<span className="badge badge-danger">NEW</span></a></li>
                                                    ...
                                                    <div className="col-lg-2">
                                                        <ul>
                                                            ...
                                                            <li><a href="shortcode-particles.html">Particles<span className="badge badge-danger">NEW</span></a></li>
                                                            <li><a href="shortcode-responsive-utilities.html">Responsive utilities</a></li>
                                                            <li><a href="component-ion-range-slider.html">Range Slider<span className="badge badge-danger">NEW</span></a></li>
                                                            ...
                                                            <li><a href="shortcode-spinners.html">Spinners<span className="badge badge-danger">NEW</span></a></li>
                                                            <li><a href="component-toggles-radio-checkboxes.html">Switch Toggle<span className="badge badge-danger">NEW</span></a></li>
                                                            <li><a href="shortcode-shape-dividers.html">Shape Dividers<span className="badge badge-danger">NEW</span></a></li>
                                                        </ul>
                                                    </div>
                                                    <div className="col-lg-2">
                                                        <ul>
                                                            <li><a href="shortcode-ratings.html">Ratings<span className="badge badge-danger">NEW</span></a></li>
                                                            ...
                                                            <li><a href="shortcode-timeline.html">Timeline<span className="badge badge-danger">NEW</span></a></li>
                                                            <li><a href="shortcode-video-background.html">Video Background</a></li>
                                                            <li><a href="shortcode-wizard.html">Wizard<span className="badge badge-danger">NEW</span></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </li>
                                    ...
                                    <li className="dropdown"><NavItem to="/contact">درباره ما</NavItem>
                                        <ul className="dropdown-menu">
                                            <li className="dropdown-submenu"><span className="dropdown-menu-title-only">About us</span>
                                                <ul className="dropdown-menu">
                                                    <li><a href="page-about-basic.html">Basic</a></li>
                                                    <li><a href="page-about-extended.html">Extended</a></li>
                                                </ul>
                                            </li>
                                            <li className="dropdown-submenu"><span className="dropdown-menu-title-only">About me</span>
                                                <ul className="dropdown-menu">
                                                    <li><a href="page-about-me-creative.html">Creative<span className="badge badge-danger">NEW</span></a></li>
                                                    <li><a href="page-about-me-basic.html">Basic</a></li>
                                                    <li><a href="page-about-me-extended.html">Extended</a></li>
                                                </ul>
                                            </li>
                                            <li className="dropdown-submenu"><span className="dropdown-menu-title-only">Contact us</span>
                                                <ul className="dropdown-menu">
                                                    <li><a href="page-contact-classNameic.html">classNameic</a></li>
                                            ...
                                            <li className="dropdown-submenu"><span className="dropdown-menu-title-only">Gallery</span>
                                                <ul className="dropdown-menu">
                                            ...
                                            <li className="dropdown-submenu"><span className="dropdown-menu-title-only">User pages</span>
                                                <ul className="dropdown-menu">
                                                    <li><a href="page-user-login.html">Login</a></li>
                                                    <li><a href="page-user-login-classNameic.html">Login - classNameic</a></li>
                                                    <li><a href="page-user-register.html">Register</a></li>
                                                    <li><a href="page-user-register-classNameic.html">Register - classNameic</a></li>
                                            ...
                                            <li className="dropdown-submenu"><span className="dropdown-menu-title-only">Page with Sidebar</span>
                                                <ul className="dropdown-menu">
                                    ...
                                    <li className="dropdown mega-menu-item"><a href="#">تماس با ما</a>
                                        <ul className="dropdown-menu">
                                            <li className="mega-menu-content">
                                                <div className="row">
                                                    <div className="col-lg-2-5">
                                                        <ul>
                                                            <li className="mega-menu-title">Grids</li>
                                                    ...
                                                    <div className="col-lg-2-5">
                                                        <ul>
                                                            <li className="mega-menu-title">Masonry</li>
                                                            <li><a href="portfolio-masonry-2.html">Two Columns</a></li>
                                                            <li><a href="portfolio-masonry-3.html">Three Columns<span className="badge badge-danger">HOT</span></a></li>
                                                    ...
                                                    <div className="col-lg-2-5">
                                                        <ul>
                                                            <li className="mega-menu-title">Styles</li>
                                                    ...
                                                    <div className="col-lg-2-5">
                                                        <ul>
                                                            <li className="mega-menu-title">Layouts</li>
                                                    ...
                                                    <div className="col-lg-2-5">
                                                        <ul>
                                                            <li className="mega-menu-title">Single Project</li>
                                                    ...
                                                    <div className="col-md-12 no-padding">
                                                        <div className="d-none d-lg-block m-t-40 m-b-10">
                                                            <div className="container">
                                                                <div className="row">
                                                                    <div className="col-lg-9 m-t-10">
                                                                        <div className="text-center center">
                                                                            <div className="heading-creative"><strong>20+</strong> Amazing Hover Styles</div>
                                                                        </div>
                                                                    </div>
                                                                    <div className="col-lg-3"><a href="portfolio-hover-styles.html" className="btn m-l-20 btn-light btn-shadow btn-light-hover btn-light-hover">View All Hover Styles</a></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <ul className="d-block d-lg-none">
                                                            <li><a className="mega-menu-title" href="portfolio-hover-styles.html">20+ Amazing Hover Styles</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </li>
